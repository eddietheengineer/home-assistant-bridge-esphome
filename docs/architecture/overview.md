...
containing compressed Home Assistant MQTT discovery entity definitions. The bridge
decompresses chunks at startup to publish discovery payloads — no network fetch or
runtime file I/O is required.
...
No network access or file I/O is needed at runtime.
...
- [Startup Sequence](./startup-sequence.md) — 9-phase startup HSM sequence diagram
- [Data Flow](./data-flow.md) — Read path, write path, discovery flow
- [Module Descriptions](./module-descriptions/) — One file per module