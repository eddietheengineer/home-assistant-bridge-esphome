...
| [Startup Sequence](./architecture/startup-sequence.md) | 9-phase startup HSM sequence diagram |
| [Data Flow](./architecture/data-flow.md) | Read path, write path, and discovery flow diagrams |
| [Module Descriptions](./architecture/module-descriptions/) | Lightweight summary for each module |
