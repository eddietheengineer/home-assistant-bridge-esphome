...
CONF_UPDATE_FASTEST_RATE = "update_fastest_rate"
...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional(CONF_UPDATE_FASTEST_RATE, default=0): cv.int_range(min=0, max=255),
...
async def to_code(config: dict[str, Any]) -> None:
    ...
    cg.add(var.set_update_fastest_rate(config[CONF_UPDATE_FASTEST_RATE]))
